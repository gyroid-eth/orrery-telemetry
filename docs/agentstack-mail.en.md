...
> 日本語版: [agentstack-mail.md](agentstack-mail.md)
...
- [Claim/enrollment design](agentstack-mail-claim-enrollment-design.en.md) frames
...
- [Performance gate design](agentstack-mail-performance-gate.en.md) specifies the
