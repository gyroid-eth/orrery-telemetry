...
| Native Windows | **Unsupported.** A development-only [Mail/dashboard startup helper](docs/windows-local.en.md) has limited coverage; it does not install agent launchers or hooks. |
